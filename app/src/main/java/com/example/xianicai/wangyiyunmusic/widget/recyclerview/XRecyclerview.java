package com.example.xianicai.wangyiyunmusic.widget.recyclerview;
...
import com.example.xianicai.wangyiyunmusic.utils.ToastUtil;
...
public class XRecyclerview extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        mSwipeRefreshLayout.setColorSchemeColors(ContextCompat.getColor(context, R.color.theme_read));
        if (mManager != null) {
            setRefreshLoadMore();
        }
    }
